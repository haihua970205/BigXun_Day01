...
import com.example.bigxun_day01.widget.NumberSelect;
...
public class CarListAdapter extends BaseAdapter<ShopCarDataBean.DataBean.CartListBean> {
    ...
    protected void bindData(ShopCarDataBean.DataBean.CartListBean data, VH vh) {
        ...
        Glide.with(imgItem).load(data.getList_pic_url()).into(imgItem);
//        ImageLoader.loadImage(data.getList_pic_url(),imgItem);
    ...
    public interface UpdateItem {
        void updateItemDate(ShopCarDataBean.DataBean.CartListBean data);
    }
}
